...
class SettingBoxRightOld extends StatefulWidget {
  const SettingBoxRightOld({super.key});

  @override
  State<SettingBoxRightOld> createState() => _SettingBoxRight();
}

class _SettingBoxRight extends State<SettingBoxRightOld> {
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: ElevatedButton(
              onPressed: () {
                _openColorPicker(context, boxBorderColor , HexColor(settingsBox.boxBorderColorRight), (color) {
                  setState(() {
